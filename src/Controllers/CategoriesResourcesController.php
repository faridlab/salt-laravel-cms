...
class CategoriesResourcesController extends Controller
{
     ...
     * @return void
     */
    public function __construct(Request $request, Categories $model, ResponseService $responder) {
        try {
    ...
    public function index(Request $request) {
        ...
        try {
            ...
            $count = $this->model->where('group', 'post_category')->count();
            $model = $this->model->where('group', 'post_category')->filter();
