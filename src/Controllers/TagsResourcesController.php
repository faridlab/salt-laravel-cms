 ...
 *  )
 */
class TagsResourcesController extends Controller
{
     ...
     * @return void
     */
    public function __construct(Request $request, Tags $model, ResponseService $responder) {
        try {
    ...
    public function index(Request $request) {
        ...
        try {
            ...
            $count = $this->model->where('group', 'post_tag')->count();
            $model = $this->model->where('group', 'post_tag')->filter();
